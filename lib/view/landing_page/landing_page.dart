          ...
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                  ...
                  children: [
                    CustomText(
                        text: 'INSPECTSTORE Is A Win-Win For Seller And Buyer',
                        fontSize: 44.sp,
                        color: blackColor,
                        width: 691.w,
                        textAlign: TextAlign.center,
                    ...
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Image.asset(sellermobile,
                              height: 570.h, width: 450.w, fit: BoxFit.contain),
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                CustomText(
                                    text:
                                        'INSPECTSTORE revolutionizes the real estate landscape, offering a win-win solution for both sellers and buyers alike.',
                                    fontSize: 30.sp,
                                    color: blackColor,
                                    width: 830.w,
                                    fontWeight: FontWeight.w400),
                                ...
                                CustomText(
                                    text:
                                        'For sellers, our platform provides an opportunity to showcase the integrity of their property through detailed house survey reports, fostering trust and transparency with potential buyers.',
                                    fontSize: 30.sp,
                                    color: blackColor,
                                    width: 830.w,
                                    // textAlign: TextAlign.center,
                                ...
                                CustomText(
                                    text:
                                        'Meanwhile, buyers benefit from accessing these comprehensive reports, gaining invaluable insights into their prospective homes and making informed decisions with confidence.',
                                    fontSize: 30.sp,
                                    color: blackColor,
                                    width: 830.w,
                                    // textAlign: TextAlign.center,
